module.exports = {
	...
	adminId: "928423284117225483", //- Replace UserId with the Discord ID of the admin of the bot
	token: process.env.token || "MTA3MTYxNzgzMTY2NzUxMTI5Ng.GhRgk_.tucLPAy4LKGidAuTfxpvOJCmouZZV8EIpMyhpk", //- Bot's Token
	clientId: process.env.clientId || "1071617831667511296", //- ID of the bot
	clientSecret: process.env.clientSecret || "55-shKIMtkuQCyzOBuN3-cdBoZesOQwq", //- Client Secret of the bot
   ...
   Spotify: {
    ClientID: process.env.Spotify_ClientID || "de7e54454745494cb4852e7652e71436d4f2c", // Spotify Client ID
